#ifndef SAR_PROJECT_XYZ_H
#define SAR_PROJECT_XYZ_H
...
namespace kinova
{
    ...
    {
    public:
        SarProjectXYZ(ros::NodeHandle &nh);
        ~SarProjectXYZ();
